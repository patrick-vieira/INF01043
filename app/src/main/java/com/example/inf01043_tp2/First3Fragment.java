...
import com.example.inf01043_tp2.databinding.FragmentFirst3Binding;
...
public class First3Fragment extends Fragment {
    ...
    public void setCoordinatesViewText(String value){
        binding.textviewCordinates.setText(value);
    }
